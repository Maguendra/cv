...
define('MYSQL_HOST', 'mysql-votre_compte.alwaysdata.net'); // Ex: mysql-moncompte.alwaysdata.net
define('MYSQL_NAME', 'votre_compte_nomdelabase');           // Ex: moncompte_cv
define('MYSQL_USER', 'votre_compte');                       // Ex: moncompte
define('MYSQL_PASSWORD', 'votre_mot_de_passe');             // Votre mot de passe AlwaysData
